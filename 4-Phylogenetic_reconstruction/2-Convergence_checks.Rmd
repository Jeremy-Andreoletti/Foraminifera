...
```{r}
output_S <- checkConvergence(list_files = list.files("/Volumes/data/Forams/4-Phylogenetic_reconstruction/output_pf95_pt95_nodeDating/", pattern = "forams_Spinose.*.trees", full.names = T), control = makeControl(burnin = 0.1))
output_S
```
...
```{r}
output_NS <- checkConvergence(list_files = list.files("/Volumes/data/Forams/4-Phylogenetic_reconstruction/output_pf95_pt95_nodeDating/", pattern = "forams_NonSpinose.*.trees", full.names = T), control = makeControl(burnin = 0.1))
output_NS
```
...
```{r}
output_M <- checkConvergence(list_files = list.files("/Volumes/data/Forams/4-Phylogenetic_reconstruction/output_pf95_pt95_nodeDating/", pattern = "forams_Microperforate.*.trees", full.names = T), control = makeControl(burnin = 0.05))
output_M
```
...
```{r fig.width=12, fig.asp=0.4}
plotEssSplits(output_M, breaks=50)
```
...
```{r}
output_S <- checkConvergence(list_files = list.files("/Volumes/data/Forams/4-Phylogenetic_reconstruction/output_pf5_pt5_nodeDating/", pattern = "forams_Spinose.*.trees", full.names = T), control = makeControl(burnin = 0.1))
output_S
```
...
```{r}
output_NS <- checkConvergence(list_files = list.files("/Volumes/data/Forams/4-Phylogenetic_reconstruction/output_pf5_pt5_nodeDating/", pattern = "forams_NonSpinose.*.trees", full.names = T), control = makeControl(burnin = 0.1))
output_NS
```
...
```{r}
output_M <- checkConvergence(list_files = list.files("/Volumes/data/Forams/4-Phylogenetic_reconstruction/output_pf5_pt5_nodeDating/", pattern = "forams_Microperforate.*.trees", full.names = T), control = makeControl(burnin = 0.05))
output_M
```
