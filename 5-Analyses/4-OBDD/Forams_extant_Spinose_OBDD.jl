...
## Read in data
treesDLM = readdlm("../../4-Phylogenetic_reconstruction/output/forams_Spinose.trees", header=true)
...
ofile    = "OBDD_Forams_Spinose_$(niter)iter_seed$(seed_nb)" ; isdir("outputs/") || mkdir("outputs/")
tune_int = 100
ϵi       = 0.2
λi       = prod(λa_prior)
μi       = prod(μa_prior)
