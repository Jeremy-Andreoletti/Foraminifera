...
tree = read_newick("../../3-Data_processed/Morphospecies_phylogenies/SpinoseOnly_sampledAncestors.tree", true)
occurrence_ages = readdlm("../../3-Data_processed/Triton_occurrences/TritonDB_subsampled_STT_28873occurrences_SpinoseOnly.csv", ';')[:]
...
ofile    = "OBDD_Forams_SpinoseOnly_sampledAncestors_$(niter)iter_seed$(seed_nb)" ; isdir("outputs/") || mkdir("outputs/")
