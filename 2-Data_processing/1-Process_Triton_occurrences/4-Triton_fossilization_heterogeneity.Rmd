...
for (i in 1:5) plot(sampling_heterogeneity_GAM, pages=0, residuals=TRUE, select=i, se=2, ylim=c(-3,1.5), theta=0, phi=90, ylab="")  ## show partial residuals
# vis.gam(sampling_heterogeneity_GAM, view=c("age", "sample.depth"), n.grid = 15, lwd=0.5, ylab="\n\nsample depth")
for (i in 1:5) plot(sampling_heterogeneity_GAM, pages=0, seWithMean=TRUE, select=i, se=2, shade=T, theta=180, phi=90, ylab="")
...
plot(sampling_heterogeneity_GAM, pages=0, residuals=TRUE, seWithMean=TRUE, select=1, theta=0, phi=90, ylab="", lwd=0.3)
