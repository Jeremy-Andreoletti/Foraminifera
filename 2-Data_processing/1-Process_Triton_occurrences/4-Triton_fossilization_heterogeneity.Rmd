...
for (geo_predictors_increasing_sampling_i in tail(geo_predictors_increasing_sampling)){
  plot(geo_predictors_increasing_sampling_i[,"pal_lat_median"], xlab = "Cumulative number of samples (chronological)", ylab = "Median latitude in abundant region", main = paste0("Median lat. convergence (", SP, ")"), ylim = c(-90,90))
  plot(geo_predictors_increasing_sampling_i[,"pal_lat_var"], xlab = "Cumulative number of samples (chronological)", ylab = "Variance in absolute latitude", main = paste0("Lat. variance convergence (", SP, ")"), ylim = c(0,1000))
  plot(geo_predictors_increasing_sampling_i[,"pal_long_median"], xlab = "Cumulative number of samples (chronological)", ylab = "Circular median longitude", main = paste0("Median long. convergence (", SP, ")"), ylim = c(-180,180))
  plot(geo_predictors_increasing_sampling_i[,"pal_long_var"], xlab = "Cumulative number of samples (chronological)", ylab = "Circular variance in longitude", main = paste0("Long. variance convergence (", SP, ")"), ylim = c(0,1))
}
```
...
plot(sampling_heterogeneity_GAM, pages=0, residuals=TRUE, seWithMean=TRUE, select=1, theta=0, phi=90, ylab="", n2=200, lwd=0.3)
...
# 
plot(sampling_heterogeneity_GAM, pages=0, residuals=TRUE, select=1, theta=180, phi=90, ylab="", n2=200, lwd=0.3)
