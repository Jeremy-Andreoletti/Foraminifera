...
triton.pres$species <- gsub("Trilobatus subsacculifer", "Trilobatus sacculifer", triton.pres$species)
triton.pres$species <- gsub("Trilobatus praeimmaturus", "Trilobatus sacculifer", triton.pres$species)
...
triton.pres$species <- gsub("Globorotalia menardii", "Globorotalia cultrata", triton.pres$species)
...
Foram_ancestry_table_alb_newTaxo$`Species in lineage` <- gsub("Trilobatus subsacculifer", "Trilobatus sacculifer", Foram_ancestry_table_alb_newTaxo$`Species in lineage`)
Foram_ancestry_table_alb_newTaxo$`Species in lineage` <- gsub("Trilobatus praeimmaturus", "Trilobatus sacculifer", Foram_ancestry_table_alb_newTaxo$`Species in lineage`)
...
Foram_ancestry_table_alb_newTaxo$`Species in lineage` <- gsub("Globorotalia menardii", "Globorotalia cultrata", Foram_ancestry_table_alb_newTaxo$`Species in lineage`)
...
triton.ss$species <- gsub("Trilobatus subsacculifer", "Trilobatus sacculifer", triton.ss$species)
triton.ss$species <- gsub("Trilobatus praeimmaturus", "Trilobatus sacculifer", triton.ss$species)
...
triton.ss$species <- gsub("Globorotalia menardii", "Globorotalia cultrata", triton.ss$species)
...
Foram_ancestry_table_alb_fossils$Species <- gsub(".*\\-", "", Foram_ancestry_table_alb_fossils$`Species in lineage`)
#nbF <- 5000
nbF <- 1000
nbF_cpt <- 0
...
#for (i in 1:nrow(triton.ss)){
  ...
  if (any(cond)) {
    ...
    triton_to_Aze_Fi$Species <- Fi$species
...
code_species_match <- Foram_ancestry_table_alb_fossils$Species
names(code_species_match) <- Foram_ancestry_table_alb_fossils$`Lineage code`

head(code_species_match)
Foram_phylo_fossils$node.species <- code_species_match[Foram_phylo_fossils$node.label]
Foram_phylo_fossils$tip.species <- code_species_match[Foram_phylo_fossils$tip.label]
```
...
q <- ggtree(Foram_phylo_fossils) + 
  geom_tiplab(#aes(label = c(Foram_phylo_fossils$tip.species, Foram_phylo_fossils$node.species)), 
              size=2.5) +
  geom_nodelab(#aes(label = c(Foram_phylo_fossils$tip.species, Foram_phylo_fossils$node.species)), 
               size=2, 
...
p$data$child_count <- sapply(p$data$node, function(x) sum(p$data$parent == x))
p$data$sampledAncestor <- !p$data$isTip & (p$data$child_count == 1)
...
Phylo_NonSpinoseOnly_sampledAncestors$tip.species <- Phylo_NonSpinoseOnly_sampledAncestors$tip.species[Phylo_NonSpinoseOnly_sampledAncestors$tip.label]
Phylo_NonSpinoseOnly_sampledAncestors$node.species <- Phylo_NonSpinoseOnly_sampledAncestors$node.species[Phylo_NonSpinoseOnly_sampledAncestors$node.label]
Phylo_SpinoseOnly_sampledAncestors$tip.species <- Phylo_SpinoseOnly_sampledAncestors$tip.species[Phylo_SpinoseOnly_sampledAncestors$tip.label]
Phylo_SpinoseOnly_sampledAncestors$node.species <- Phylo_SpinoseOnly_sampledAncestors$node.species[Phylo_SpinoseOnly_sampledAncestors$node.label]
Phylo_MixedSpinose_sampledAncestors$tip.species <- Phylo_MixedSpinose_sampledAncestors$tip.species[Phylo_MixedSpinose_sampledAncestors$tip.label]
Phylo_MixedSpinose_sampledAncestors$node.species <- Phylo_MixedSpinose_sampledAncestors$node.species[Phylo_MixedSpinose_sampledAncestors$node.label]
...
```{r}
write.tree(Phylo_NonSpinoseOnly_sampledAncestors, "../../3-Data_processed/Morphospecies_phylogenies/NonSpinoseOnly_sampledAncestors.tree")
write.tree(Phylo_SpinoseOnly_sampledAncestors, "../../3-Data_processed/Morphospecies_phylogenies/SpinoseOnly_sampledAncestors.tree")
write.tree(Phylo_MixedSpinose_sampledAncestors, "../../3-Data_processed/Morphospecies_phylogenies/MixedSpinose_sampledAncestors.tree")
save(Phylo_NonSpinoseOnly_sampledAncestors, file = "../../3-Data_processed/Morphospecies_phylogenies/NonSpinoseOnly_sampledAncestors.RData")
save(Phylo_SpinoseOnly_sampledAncestors, file = "../../3-Data_processed/Morphospecies_phylogenies/SpinoseOnly_sampledAncestors.RData")
save(Phylo_MixedSpinose_sampledAncestors, file = "../../3-Data_processed/Morphospecies_phylogenies/MixedSpinose_sampledAncestors.RData")
```
